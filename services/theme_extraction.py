...
class ThemeExtraction:
    ...
    def __init__(self):
        ...
        self.themes = {
            ...
            "Performance": "fast slow speed latency delay loading",

            "Bug": "crash error exception defect failure bug",

            "Security": "login password sso authentication security privacy",

            "Integration": "api webhook export sync third party integration",

            "Billing": "price cost subscription invoice billing charge"
