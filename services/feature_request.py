    ...
    def __init__(self):
        ...
        self.features = {
            ...
            "Export Functionality":
                "export pdf csv download file data",

            "Integration":
                "integration api webhook connect third party",

            "Performance":
                "speed optimization fast loading response time",

            "Security":
                "sso 2fa authentication password security"
